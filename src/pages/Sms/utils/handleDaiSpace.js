function handleDaiSpace(content) {
    ...
    while (vt !== -1) {
        if (isFinite(Number(contentTmp[vt - 1]))) {
            ...
            (contentTmp[vt + 3] === '.' || isFinite(Number(contentTmp[vt + 3]))) &&
            isFinite(Number(contentTmp[vt + 4]))
        ) {
            contentTmp = contentTmp.slice(0, vt) + '2d' + contentTmp.slice(vt + 3);
        }
    ...
    while (vt !== -1) {
        if (isFinite(Number(contentTmp[vt - 1]))) {
            ...
            contentTmp = contentTmp.slice(0, vt) + '3d' + contentTmp.slice(vt + 3);
        }
    ...
    while (vt !== -1) {
        if (isFinite(Number(contentTmp[vt - 1]))) {
            ...
            contentTmp = contentTmp.slice(0, vt) + '4d' + contentTmp.slice(vt + 3);
        }
